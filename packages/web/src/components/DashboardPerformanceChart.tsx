...
export function DashboardPerformanceChart({
  ...
  // Single data point - show stats
  if (chartData.length === 1) {
    const point = chartData[0];
    return (
      <div className="dashboard-performance-chart">
        {title && <h3>{title}</h3>}
        <div className="performance-chart-single">
          <div className="performance-stat">
            <span className="performance-stat-value">{point.passRate}%</span>
            <span className="performance-stat-label">Pass Rate</span>
          </div>
          <div className="performance-stat">
            <span className="performance-stat-value">
              {formatLatency(point.avgLatency)}
            </span>
            <span className="performance-stat-label">Avg Latency</span>
          </div>
          <div className="performance-stat">
            <span className="performance-stat-value">{point.totalRuns}</span>
            <span className="performance-stat-label">Total Runs</span>
          </div>
        </div>
      </div>
    );
